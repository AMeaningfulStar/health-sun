  ...
  return (
    <div className="h-14 w-24 rounded-xl bg-gray-200 p-2">
      <div className="flex h-full w-full rounded-lg bg-slate-400">
        <div
          className={`flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg ${theme === 'light' ? 'bg-white' : ''}`}
        ...
        <div
          className={`flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg ${theme === 'dark' ? 'bg-white' : ''}`}
